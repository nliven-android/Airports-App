...
public class GetAirports {
    ...
    public static void execute() {
        ...
        client.get(REQUEST_URL, new TextHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, String content) {
                ...
                gsonBuilder.registerTypeAdapter(Airport[].class, new GetAirports.AirportDeserializer());
    ...
    /**
     * Doing it this way b/c I havent been able to find a way to mark the 
     ...
     * map it to the "Airport" entity/model class.
     */
